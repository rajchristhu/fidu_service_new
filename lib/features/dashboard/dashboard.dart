                                ...
                                children: [
                                  ...
                                  Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children:  [
                                          Text("Hello!",style: TextStyle(color: blackColor,fontWeight: FontWeight.w600,fontSize:15),),
                                          SizedBox(height: 6,),
                                          Text("Maria Christhu Rajan fjhbfbhbhwebfhjewbfhb",style: TextStyle(color:blackColor,overflow: TextOverflow.ellipsis,fontWeight: FontWeight.w600),)
                                        ],)
                                  ),
              ...
              child:CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  child: IconButton(
                      ...
                      icon: Icon(Icons.notifications, size: 18, color: dark_blue),
                      onPressed: () {
                ...
                child:CircleAvatar(
                  ...
                  child: CircleAvatar(
                    ...
                    child: IconButton(
                        ...
                        highlightColor: Colors.transparent,
                        focusColor: Colors.transparent,
                        icon: Icon(Icons.menu_rounded, size: 18, color: dark_blue),
                        onPressed: () {
                          _scaffoldKey.currentState!.openEndDrawer();
                        }), //CircleAvatar
                  ), //CircleAvatar
